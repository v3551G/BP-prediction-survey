...
from tensorflow.keras.layers import Input, Add, Dense, Activation, ZeroPadding1D, BatchNormalization, Flatten, Conv1D, \
    AveragePooling1D, MaxPooling1D, ReLU
from tensorflow.keras.models import Model

"""
   Definition of ResNet model modified for BP estimation.
   
   Reference: 
   1. Ren S, Sun J, He K, et al. Deep residual learning for image recognition[C]//CVPR. 2016, 2: 4.
"""
